 ...
 * index
 */
//$lang['store_goods_index_auditing_tip']	 		= '您的店舖正在審核過程中，審核通過商品管理功能才能使用！';
...
$lang['store_goods_index_store_price_interval']	= '商品價格必須是0.01~1000000之間的數字';
$lang['store_goods_index_goods_stock_null']		= '商品庫存不能為空';
$lang['store_goods_index_goods_stock_error']	= '庫存只能填寫數字';
$lang['store_goods_index_goods_weight_null']    = '商品重量不能為空';
...
$lang['store_goods_index_belong_multiple_store_class']	= '商品可以從屬於店舖的多個分類之下,</br>店舖分類可以由 "用戶中心 -> 賣家 -> 商品管理 -> 分類管理" 中自定義';
...
$lang['store_goods_index_store_price_help']		= '商品價格必須是0.01~1000000之間的數字</br>若啟用了庫存配置，請在下方商品庫存區域進行管理</br>商品規格庫存表中如有價格差異，店舖價格顯示為價格區間形式';
$lang['store_goods_index_goods_stock']			= '商品庫存';
$lang['store_goods_index_goods_stock_checking']	= '商舖庫存數量必須為1~1000000000之間的整數';
$lang['store_goods_index_goods_stock_help']		= '商舖庫存數量必須為1~1000000000之間的整數</br>若啟用了庫存配置，則系統自動計算商品的總數，此處無需賣家填寫';
...
$lang['store_goods_index_goods_no_help']		= '商品貨號是指賣家個人管理商品的編號，買家不可見</br>最多可輸入20個字元，支持輸入中文、字母、數字、_、/、-和小數點';
...
$lang['store_goods_index_again_choose_category']		= '您選擇的分類不存在，或沒有選擇到最後一級，請重新選擇分類。';
$lang['store_goods_step2_image']						= '圖片（無圖片可不填）';
$lang['store_goods_step2_indate']						= '有效期';
$lang['store_goods_step2_7_day']						= '7天';
$lang['store_goods_step2_14_day']						= '14天';
...
$lang['store_goods_step3_choose_add']					= '選擇商品參加';
$lang['store_goods_step3_groupbuy_activity']			= '團購活動';
...
$lang['store_goods_brand_icon_null']			= '品牌表徵圖不能等於空';
...
2.如果因為淘寶助理版本差異表頭名稱有出入，請先修改成上述的名稱方可導入。<br/>
...
/*淘寶檔案導入*/
$lang['store_goods_import_goodsname'] = '寶貝名稱';
$lang['store_goods_import_goodscid'] = '寶貝類目';
$lang['store_goods_import_goodsprice'] = '寶貝價格';
$lang['store_goods_import_goodsnum'] = '寶貝數量';
$lang['store_goods_import_goodstuijian'] = '櫥窗推薦';
$lang['store_goods_import_goodsdesc'] = '寶貝描述';
$lang['store_goods_import_goodspic'] = '新圖片';
$lang['store_goods_import_goodsproperties'] = '銷售屬性組合';
