...
class bundlingControl extends BaseStoreControl{
	...
	public function indexOp() {
		...
		//检查店铺状态
		$store_info = $this->checkStoreState($store_id,Language::get('goods_index_goods_store_closed'));
		//得到店铺展示信息
		...
		// 随机显示四个组合销售
		$other_bundling = $model->table('p_bundling')->where('bl_id <>'.$bl_id .' and bl_state = 1')->order('rand()')->limit(4)->select();
		// 整理
