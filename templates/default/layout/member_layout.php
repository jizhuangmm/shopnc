  ...
  <div class="layout">
    ...
    <div class="sidebar">
      <dl class="ncu-user">
        ...
        <dd class="userface"><div class="pic"><span class="thumb size100"><i></i><img src="<?php if ($output['member_info']['member_avatar']!='') { echo ATTACH_AVATAR.DS.$output['member_info']['member_avatar']; } else { echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,100,100);" alt="<?php echo $output['member_info']['member_name']; ?>" /></span>
          <p><a href="index.php?act=home&op=avatar" title="<?php echo $lang['nc_updateavatar'];?>"><?php echo $lang['nc_updateavatar'];?></a><i></i></p></div>
        </dd>
        <dd class="info"><ul><li><?php if (empty($output['member_info']['credit_arr'])){ echo $lang['nc_buyercredit'].$lang['nc_colon'].$output['member_info']['member_credit']; }else {?>
      ...
      <div class="business-intro">
        ...
        <ul>
          <li><span><a href="index.php?act=member&op=order&state_type=order_pay"><?php echo $lang['nc_order_waitpay'];?></a></span>
          	<i <?php if($output['member_info']['order_nopay'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_nopay'];?></i></li>
          <li><span><a href="index.php?act=member&op=order&state_type=order_shipping"><?php echo $lang['nc_order_receiving'];?></a></span>
          	<i <?php if($output['member_info']['order_noreceiving'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_noreceiving'];?></i></li>
          <li><span><a href="index.php?act=member&op=order&state_type=noeval"><?php echo $lang['nc_order_waitevaluate'];?></a></span>
          	<i <?php if($output['member_info']['order_noeval'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_noeval'];?></i></li>
        </ul>
      </div>
