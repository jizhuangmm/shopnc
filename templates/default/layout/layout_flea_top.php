<div id="page">
  <div id="topNav" class="warp-all">
    ...
    <ul class="quick-menu">
      ...
      <li class="cart">
        <div class="menu" ><span class="menu-hd"><s></s><?php echo $lang['nc_cart'];?><strong class="goods_num"><?php echo intval($output['cart_goods_num']); ?></strong><?php echo $lang['nc_kindof_goods'];?><i></i></span>
