  ...
  <form method="get" action="index.php">
    <table class="search-form">
      <tr>
        ...
        <th><?php echo $lang['refund_order_add_time'].$lang['nc_colon'];?></th>
  ...
  <table class="ncu-table-style">
    <thead>
      <tr>
        ...
        <th class="w150"><?php echo $lang['refund_order_add_time'];?></th>
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['nc_view'];?>" dialog_id="refund_order" dialog_width="400" uri="index.php?act=refund&op=view&log_id=<?php echo $val['log_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
