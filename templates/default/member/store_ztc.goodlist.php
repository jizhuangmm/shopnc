  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr nc_type="table_item" idvalue="<?php echo $val['goods_id']; ?>">
        <td><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>" target="_blank"> <img src="<?php  echo cthumb($val['goods_image'],'tiny',$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,50,50);" /> </a></td>
