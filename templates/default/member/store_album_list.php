        ...
        <dl>
          <dt>
            <div class="covers"><a href="index.php?act=store_album&op=album_pic_list&id=<?php echo $v['aclass_id']?>"> <span class="thumb size150"><i></i>
              ...
              <img src="<?php echo SiteUrl.DS.ATTACH_GOODS.DS.$_SESSION['store_id'].DS.$v['aclass_cover'];?>" onerror="this.src='<?php echo TEMPLATES_PATH.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,150,150);">
              <?php }else{?>
