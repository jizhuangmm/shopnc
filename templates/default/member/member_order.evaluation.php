    ...
    <form id="evalform" method="post" action="index.php?act=member_evaluate&op=add&order_id=<?php echo $_GET['order_id'];?>" onsubmit="return checkform();">
      ...
      <table class="ncu-table-style order deliver">
        <tbody>
          ...
          <tr>
            <td class="bdl w10"></td>
            <td class="w70"><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $goods['goods_id']; ?>&id=<?php echo $output['store_info']['store_id'];?>" target="_blank"><img src="<?php echo $goods['goods_image']; ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
            <td class="tl goods-info"><dl>
                <dt><a href="index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>&id=<?php echo $output['store_info']['store_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></dt>
