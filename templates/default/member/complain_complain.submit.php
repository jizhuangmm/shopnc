      ...
      <table class="order ncu-table-style">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$order_goods['goods_id'],'id'=>$output['order_info']['store_id']), 'goods');?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);"  src="<?php echo cthumb($order_goods['goods_image'],'tiny',$output['order_info']['store_id']);?>" /> </a></span></div></td>
            <td class="tl"><dl class="goods-name">
              <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$order_goods['goods_id'],'id'=>$output['order_info']['store_id']), 'goods');?>" target="_blank"><?php echo $order_goods['goods_name'];?></a></dt>
