...
<div class="eject_con">
  <div class="adds">
    <div id="warning"></div>
    <form method="post" action="index.php?act=deliver&op=pop_address" id="address_form" target="_parent">
      ...
      <dl class="bottom"><dt>&nbsp;</dt><dd>
        <input type="submit" class="submit" value="<?php echo $lang['nc_common_button_save'];?>" />
      </dd></dl>
    </form>
  </div>
</div>
