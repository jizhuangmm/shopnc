  ...
  <table class="ncu-table-style">
    ...
    <tbody id="treet1">
      ...
      <tr class="bd-line">
        ...
        <td><?php echo $output['payment_array'][$val['gbuy_check_type']];?></td>
        <td><?php if ($val['gbuy_ispay'] == 0) { ?>
          <p><a href="javascript:void(0)" nc_type="dialog" dialog_width="480" dialog_title="<?php echo $lang['store_gbuy_pay'];?>" dialog_id="store_gbuy_payment" uri="index.php?act=store_gbuy&op=payment&gbuy_id=<?php echo $val['gbuy_id']; ?>; ?>"><?php echo $lang['store_gbuy_pay'];?></a></p><p><a href="javascript:void(0)" class="ncu-btn2 mt5" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>','index.php?act=store_gbuy&op=del&gbuy_id=<?php echo $val['gbuy_id']; ?>');"><?php echo $lang['nc_del_&nbsp'];?></a></p>
          <?php } ?>
