<div class="eject_con">
  ...
  <table class="ncu-table-style order bc mt20 mb10" style="width:96%;">
    ...
    <tbody>
      ...
      <tr><td class="bdl w10"></td><td><div class="goods-pic-small"><span class="thumb size60"><i></i><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><img src="<?php echo thumb($val,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
        <td><dl class="goods-name" style="width:auto;">
          <dt style="width:auto; white-space: normal;"><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><?php echo $val['goods_name']; ?></a></dt>
