  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><div class="goods-pic-small"> <span class="thumb size60"> <i></i><a href="index.php?act=show_store&id=<?php echo $favorites['store']['store_id'];?>" target="_blank"><img src="<?php if (!empty($favorites['store']['store_logo'])) { echo ATTACH_STORE.'/'.$favorites['store']['store_logo']; } else { ?><?php echo TEMPLATES_PATH;?>/images/member/default_store_logo.gif<?php } ?>" onload="javascript:DrawImage(this,60,60);"/></a></span></div></td>
