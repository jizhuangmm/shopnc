    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="tl goods-info"><dl>
            <dt><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $v['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><?php echo $v['goods_name']; ?></a></dt>
        ...
        <td class="bdl bdr order-info w400" rowspan="<?php echo count($val['goods']);?>"><dl>
            ...
            <dd class="vm"><?php echo $val['buyer_name']; ?> <a target="_blank" class="message" href="index.php?act=home&op=sendmsg&member_id=<?php echo $val['buyer_id'];?>" title="<?php echo $lang['nc_member_path_sendmsg']?>"></a>
              ...
              <a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=<?php echo $output['member_array'][$val['buyer_id']]['member_qq'];?>&amp;Site=<?php echo $v['member_array'][$val['buyer_id']]['member_qq'];?>&amp;Menu=yes" target="_blank" class="vm"><img src="http://wpa.qq.com/pa?p=1:<?php echo $output['member_array'][$val['buyer_id']]['member_qq'];?>}:4" alt="QQ"></a>
              <?php }?>
              <?php if(!empty($output['member_array'][$val['buyer_id']]['member_ww'])){?>
              <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<?php echo $output['member_array'][$val['buyer_id']]['member_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" class="vm" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $output['member_array'][$val['buyer_id']]['member_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="Wang Wang" /></a>
              <?php }?>
              <?php if(!empty($output['member_array'][$val['buyer_id']]['member_msn'])){?>
              <a target="_blank" href="http://settings.messenger.live.com/Conversation/IMMe.aspx?invitee=<?php echo $output['member_array'][$val['buyer_id']]['member_msn'];?>" class="vm"><img src="http://messenger.services.live.com/users/<?php echo $output['member_array'][$val['buyer_id']]['member_msn'];?>/presenceimage/" alt="MSN" /></a>
              <?php }?>
            </dd>
          </dl>
          <dl>
