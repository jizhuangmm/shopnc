...
<div class="wrap">
  ...
  <form id="explainform" method="post" action="index.php?act=<?php echo $output['pj_act'];?>&op=explain&id=<?php echo $output['info']['geval_id']; ?>">
    ...
    <dl>
      ...
      <dd><a target="_blank" href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$output['info']['geval_goodsid'],'id'=>$output['info']['geval_storeid']), 'goods'); ?>"><?php echo $output['info']['geval_goodsname']?></a></dd>
    </dl>
    <dl>
