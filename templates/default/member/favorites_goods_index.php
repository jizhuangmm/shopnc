    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><p> <a href="index.php?act=show_store&id=<?php echo $favorites['goods']['store_id'];?>" target="_blank"><?php echo $favorites['goods']['store_name'];?></a>
          ...
          <a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=<?php echo $favorites['goods']['store_qq'];?>&amp;Site=<?php echo $favorites['goods']['store_qq'];?>&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:<?php echo $favorites['goods']['store_qq'];?>}:4" alt="QQ" style=" vertical-align:middle;"></a>
          <?php }?>
          ...
          <?php }?>
          <?php if(!empty($favorites['goods']['store_msn'])){?>
          <a target="_blank" href="http://settings.messenger.live.com/Conversation/IMMe.aspx?invitee=<?php echo $favorites['goods']['store_msn'];?>"><img src="http://messenger.services.live.com/users/<?php echo $favorites['goods']['store_msn'];?>/presenceimage/" alt="status"  style=" vertical-align:middle;"/></a>
          <?php }?></p></td>
