...
<div class="wrap">
  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td>&nbsp;</td>
        <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $output['xianshi_info']['store_id'];?>" target="_blank"><img src="<?php echo cthumb($val['goods_image'],'tiny',$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
        <td class="tl"><dl class="goods-name">
          <dt><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $output['xianshi_info']['store_id'];?>" target="_blank"><?php echo $val['goods_name']; ?></a></dt>
