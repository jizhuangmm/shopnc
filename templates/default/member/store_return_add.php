<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=return&op=add&order_id=<?php echo $output['order']['order_id']; ?>">
	...
	?>
        <tr>
          <td class="bdl w10"></td>
          <td class="w70"><div class="goods-pic-small"><span class="thumb size60"><i></i><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><img src="<?php echo thumb($val,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
