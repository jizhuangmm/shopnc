<div class="wp">
  ...
  <div class="goods-release-success">
    ...
    <p><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$output['goods_id'],'id'=>$_SESSION['store_id']), 'goods')?>"><?php echo $lang['store_goods_step3_viewed_product'];?>&gt;&gt;</a><a href="index.php?act=store_goods&op=edit_goods&goods_id=<?php echo $output['goods_id']; ?>"><?php echo $lang['store_goods_step3_edit_product'];?>&gt;&gt;</a></p>
    <dl>
