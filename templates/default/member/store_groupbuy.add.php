...
<div class="wrap">
  ...
  <div class="ncu-form-style">
    <form id="add_form" action="index.php?act=store_groupbuy&op=groupbuy_save" method="post" enctype="multipart/form-data">
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['min_quantity'].$lang['nc_colon'];?></dt>
        <dd>
          <p>
            <input class="w60 text" id="input_min_quantity" name="input_min_quantity" type="text" value="<?php echo empty($output['group_info']['min_quantity'])?1:$output['group_info']['min_quantity'];?>"/>
            <span></span></p>
          <p class="hint"><?php echo $lang['min_quantity_explain'];?></p>
        </dd>
      </dl>
      <dl>
    	...
    	submitHandler:function(form){
            ...
            rules : {
                ...
                messages : {
                    ...
                    input_min_quantity : {
                        required : '<?php echo $lang['min_quantity_error'];?>',
                        digits : '<?php echo $lang['min_quantity_error'];?>',
                        min : '<?php echo $lang['min_quantity_error'];?>'
                    },
                    input_virtual_quantity: {
