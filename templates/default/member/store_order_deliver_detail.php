  ...
  <div class="express-oredr">
    ...
    <ul>
      <?php if(is_array($output['order_goods_list']) and !empty($output['order_goods_list'])) {
				...
				?>
      <li>
        <div class="goods-pic-small"><span class="thumb size60 tip" title="<?php echo $val['goods_name']; ?>"><i></i><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><img src="<?php echo thumb($val,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);"/></a></span> </div>
