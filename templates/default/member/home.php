  ...
  <div class="intro">
    <div class="left">
      ...
      <dl class="basic">
        ...
        <dd class="cert">
          <?php if($output['store_info']['name_auth'] == 0 && $output['store_info']['store_auth'] == 0){?>
          <a href="index.php?act=store&op=store_certified"><?php echo $lang['store_not_certified'];?></a>
          <?php }?>
          <?php if($output['store_info']['name_auth']){?>
          <img src="<?php echo TEMPLATES_PATH;?>/images/member/cert_autonym.gif"/>
          <?php }?>
          <?php if($output['store_info']['store_auth']){?>
          <img src="<?php echo TEMPLATES_PATH;?>/images/member/cert_material.gif" />
          <?php }?>
        </dd>
