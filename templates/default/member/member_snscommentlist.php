...
<div class="comment-widget">
  <div class="comment-edit">
    <form id="commentform_<?php echo $output['tid'];?>" method="post" action="index.php?act=member_snsindex&op=addcomment">
      ...
      <div class="comment-add">
        ...
        <!-- 验证码 -->
        <div id="commentseccode<?php echo $output['tid'];?>" class="seccode">
  ...
  <ul class="comment-list">
    ...
    <li nc_type="commentrow_<?php echo $v['comment_id']; ?>"> <a target="_blank" href="index.php?act=member_snshome&mid=<?php echo $v['comment_memberid'];?>"><img width="30" height="30" class="clogo" src="<?php if ($v['comment_memberavatar']!='') { echo ATTACH_AVATAR.DS.$v['comment_memberavatar']; } else {  echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,30,30);"></a>
      <div class="detail">
  ...
  <div class="more"><a target="_blank" href="index.php?act=member_snshome&op=traceinfo&mid=<?php echo $output['member_info']['member_id'];?>&id=<?php echo $output['tid'];?>"><?php echo $lang['sns_comment_more'];?></a></div>
...
$(function(){
	...
	//评论提交
	$("[nc_type='commentbtn']").live('click',function(){
