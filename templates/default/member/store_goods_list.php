  ...
  <table id="my_goods" class="ncu-table-style" server="index.php?act=store_goods&op=edit_goods_ajax">
    ...
    <tbody>
      ...
      <tr nc_type="table_item" idvalue="<?php echo $val['goods_id']; ?>">
        <td>&nbsp;</td>
        <td class="w70"><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>" target="_blank"><img src="<?php echo thumb($val,'tiny');?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
