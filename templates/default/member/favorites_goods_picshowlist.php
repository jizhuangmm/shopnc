            ...
            <li>
              <dl>
                <dt>
                  ...
                  <a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>&id=<?php echo $favorites['goods']['store_id'];?>" target="_blank"><?php echo $favorites['goods']['goods_name'];?></a></dt>
                <dd class="picture">
                  <div class="thumb size160"><i></i><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>&id=<?php echo $favorites['goods']['store_id'];?>" target="_blank"><img src="<?php echo thumb($favorites['goods'],'small');?>" onload="javascript:DrawImage(this,160,160);" /></a></div>
