  ...
  <form method="GET">
    ...
    <table class="ncu-table-style" >
      ...
      <tbody>
        ...
        <tr class="bd-line">
          <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $v['goods_id']; ?>&id=<?php echo $v['store_id'];?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'],'tiny',$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="20"><ul class="list">
                ...
                <li>
                  <div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>&id=<?php echo $v['store_id'];?>" target="_blank"><img alt="<?php echo $goods['goods_name'];?>" title="<?php echo $goods['goods_name'];?>" src="<?php echo cthumb($goods['goods_image'],'tiny',$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div>
                  <h4>
                    <input type="checkbox" value="<?php echo $goods['goods_id'];?>" name="item_id[]" class="checkitem"/>
                    <label><a href="index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>&id=<?php echo $v['store_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></label>
                  </h4>
                </li>
                <?php }?>
                <div class="clear"></div>
