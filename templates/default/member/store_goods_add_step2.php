...
<div class="wp">
  ...
  <div class="item-publish">
    <form method="post" id="goods_form" enctype="multipart/form-data" action="index.php?act=store_goods&op=<?php if ($output['goods']['goods_id']!='') echo 'edit_save_goods'; else echo 'save_goods'; ?>">
      ...
      <input type="hidden" name="goods_indate" value="7" />
      <div class="goods-attribute">
        ...
        <!--<dl>
          <dt><?php echo $lang['store_goods_step2_indate'].$lang['nc_colon'];?></dt>
          <dd>
            <p>
              <label style="padding-right:8px;">
                <input name="goods_indate" value="7" <?php if ($output['goods']['goods_indate'] == '7' or $output['goods']['goods_id'] == '') { ?>checked="checked" <?php } ?> type="radio" />
                <?php echo $lang['store_goods_step2_7_day'];?></label>
              <label>
                <input name="goods_indate" value="14" <?php if ($output['goods']['goods_indate'] == '14' and $output['goods']['goods_id'] != '') { ?>checked="checked" <?php } ?> type="radio"/>
                <?php echo $lang['store_goods_step2_14_day'];?></label>
            </p>
          </dd>
        </dl>-->
        <dl>
