<div class="wrap-shadow">
  <div class="wrap-all ncu-order-view">
      ...
      <dl>
        ...
        <dt>MSN<?php echo $lang['nc_colon'];?></dt>
        <dd><?php echo $output['store_info']['store_msn']; ?></dd>
      ...
      <table class="ncu-table-style">
        ...
        <tbody>
          ...
          <tr class="bd-line">
            <td></td>
            <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><img src="<?php echo thumb($val,'tiny'); ?>" /></a></span></div></td>
            <td class="tl"><dl class="goods-name">
                <dt><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>"><?php echo $val['goods_name']; ?></a></dt>
      ...
      <ul class="log-list">
        ...
        <li> <span class="log-time"><?php echo date("Y-m-d H:i:s",$val['add_time']); ?></span> <a href="index.php?act=refund&type=refund_sn&keyword=<?php echo $val['refund_sn']; ?>"><?php echo $val['refund_sn'];?></a> <?php echo $val['refund_paymentname'].$lang['nc_colon'];?><strong><?php echo $lang['currency'];?><?php echo $val['order_refund']; ?></strong> </li>
        <?php } ?>
      </ul>
      <?php } ?>
