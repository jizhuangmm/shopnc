...
<div class="wrap">
  ...
  <table class="ncu-table-style shoplist">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml10"><?php echo $lang['favorite_store_name'].$lang['nc_colon'];?><a href="index.php?act=show_store&id=<?php echo $goods_list[0]['goods']['store_id'];?>" target="_blank"><?php echo $goods_list[0]['goods']['store_name'];?></a>
          ...
          <?php }?>
          </span> <span class="ml30"><?php echo $lang['favorite_store_owner'].$lang['nc_colon'];?><a href="index.php?act=member_snshome&mid=<?php echo $goods_list[0]['goods']['member_id'];?>"><?php echo $goods_list[0]['goods']['member_name'];?></a><a target="_blank" href="index.php?act=home&op=sendmsg&member_id=<?php echo $goods_list[0]['goods']['member_id'];?>" class="message" title="<?php echo $lang['nc_message'];?>"></a></span><span class="ml30">
          <?php if(!empty($goods_list[0]['goods']['store_qq'])){?>
          <?php echo $lang['favorite_message'].$lang['nc_colon'];?><a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=<?php echo $goods_list[0]['goods']['store_qq'];?>&amp;Site=<?php echo $goods_list[0]['goods']['store_qq'];?>&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:<?php echo $goods_list[0]['goods']['store_qq'];?>}:4" alt="QQ"></a>
          <?php }?>
      ...
      <tr class="bd-line">
        ...
        <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>&id=<?php echo $favorites['goods']['store_id'];?>" target="_blank"><img src="<?php echo thumb($favorites['goods'],'tiny');?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div>
        ...
        <td class="tl"><dl class="goods-name">
            <dt><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>&id=<?php echo $favorites['goods']['store_id'];?>" target="_blank"><?php echo $favorites['goods']['goods_name'];?></a></dt>
