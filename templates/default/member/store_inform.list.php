...
<div class="wrap">
  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td class="tl"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['inform_goods_id'],'id'=>$val['store_id']), 'goods');?>" target="_blank"> <?php echo $val['inform_goods_name']; ?> </a></td>
