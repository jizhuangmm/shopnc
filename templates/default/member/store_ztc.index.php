  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>&id=<?php echo $val['store_id'];?>" target="_blank"><img src="<?php echo thumb($val,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
        <td class="tl"><a href="index.php?act=goods&goods_id=<?php echo $val['ztc_goodsid']; ?>&id=<?php echo $val['ztc_storeid'];?>" target="_blank"><?php echo $val['ztc_goodsname']; ?></a></td>
