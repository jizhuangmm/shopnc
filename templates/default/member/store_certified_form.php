...
<div class="ncu-form-style">
  <form method="post" enctype="multipart/form-data" action="index.php?act=store&op=store_certified" onsubmit="ajaxpost('my_store_form', '', '', 'onerror');return false;" id="my_store_form">
    ...
    <dl>
      ...
      <dd><span class="fl mr10"><img src="<?php echo TEMPLATES_PATH.'/images/member/cert_autonym.gif';?>" /></span><a href="<?php echo ATTACH_AUTH.'/'.$output['store_info']['store_image'];?>" target="_blank" class="fl mr10"><?php echo $lang['member_store_cert_view_file'];?></a>
        <?php if ($output['store_info']['name_auth'] == 0){?>
        <span class="hint fl"> (<?php echo $lang['member_store_cert_audit'];?>)
        <?php }else {?>
        (<?php echo $lang['member_store_cert_audit_complate'];?>)</span>
        <?php }?>
      </dd>
    </dl>
    <?php }?>
    ...
    <dl>
      ...
      <dd><span class="fl mr10"><img src="<?php echo TEMPLATES_PATH.'/images/member/cert_material.gif';?>" /></span><a href="<?php echo ATTACH_AUTH.'/'.$output['store_info']['store_image1'];?>" target="_blank" class="fl mr10"><?php echo $lang['member_store_cert_view_file'];?></a>
        <?php if ($output['store_info']['store_auth'] == 0){?>
    ...
    <?php }}?>
    <?php if (empty($output['store_info']['store_image']) || empty($output['store_info']['store_image1']) || $output['store_info']['store_auth'] == '1' || $output['store_info']['name_auth'] == '1'){?>
    <h3><?php echo $lang['member_store_cert_re'];?></h3>
    <?php if (empty($output['store_info']['store_image'])||$output['store_info']['name_auth'] == '1'){?>
    <dl>
    ...
    <?php }?>
    <?php if (empty($output['store_info']['store_image1'])||$output['store_info']['store_auth'] == '1'){?>
    <dl>
    ...
    <dl>
      <dt class="required"><em class="pngFix"></em><?php echo $lang['member_store_cert_re_notes'];?></dt>
      <dd></dd>
    </dl>
    <?php }?>
    <dl class="bottom">
