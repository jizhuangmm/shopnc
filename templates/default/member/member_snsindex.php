...
<div class="wrap">
  <div class="layout-l">
    ...
    <div class="tabmenu" style="z-index:0;">
      <ul class="tab pngFix">
        <li class="active"><a id="tabGoodsIntro" href="javascript:void(0)" ><span><?php echo $lang['sns_friendtrace'];?></span></a></li>
      </ul>
    </div>
...
var max_recordnum = '<?php echo $output['max_recordnum'];?>';
	...
	$(function(){
		...
		$('#snssharegoods').click(function(){
		    ajax_form("sharegoods", '<?php echo $lang['sns_share_purchasedgoods'];?>', '<?php echo SiteUrl.DS;?>index.php?act=member_snsindex&op=sharegoods', 500);
		    return false;
		});
		//显示分享店铺页面
