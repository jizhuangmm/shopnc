...
<div class="nc-s-c-s1 ncs-search-bar">
  <div class="title">
  ...
  <div class="content">
    ...
    <div class="ncs-top-panel">
      ...
      <ol>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods');?>"><?php echo $val['goods_name']?></a></dt>
            <dd class="goods-pic"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods');?>"><span class="thumb size40"><i></i><img src="<?php echo thumb($val,'tiny');?>"  onload="javascript:DrawImage(this,40,40);"></span></a>
    ...
    <div class="ncs-top-panel hide">
      ...
      <ol>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods');?>"><?php echo $val['goods_name']?></a></dt>
            <dd class="goods-pic"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods');?>" title=""><span class="thumb size40"><i></i> <img src="<?php echo thumb($val,'tiny');?>" onload="javascript:DrawImage(this,40,40);"></span></a>
              <p><span class="thumb size100"><i></i><img src="<?php echo thumb($val,'small');?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $val['goods_name']?>"><big></big><small></small></span></p>
            </dd>
            <dd class="price pngFix"><?php echo $val['goods_store_price']?></dd>
