        ...
        <div class="nc-s-c-s3 ncg-list">
          ...
          <div class="content">
            ...
            <ul>
              ...
              <li>
                <dl>
                  <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods');?>" target="_blank"><?php echo $value['goods_name']?></a></dt>
                  <dd class="ncg-pic pngFix"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods');?>" target="_blank" class="thumb size160"><i></i><img src="<?php echo thumb($value,'small');?>" onload="javascript:DrawImage(this,160,160);" title="<?php echo $value['goods_name'];?>" alt="<?php echo $value['goods_name'];?>" /></a></dd>
