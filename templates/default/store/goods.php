        ...
        <section class="nc-s-c-s2 ncg-com-list">
          ...
          <div class="content">
            <ul>
              ...
              <li>
                <dl>
                  <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods_commend['goods_id'],'id'=>$goods_commend['store_id']), 'goods');?>" target="_blank"><?php echo $goods_commend['goods_name'];?></a></dt>
                  <dd class="ncg-pic"><span class="thumb"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods_commend['goods_id'],'id'=>$goods_commend['store_id']), 'goods');?>" target="_blank"><img height="150" width="150" src="<?php echo thumb($goods_commend,'small');?>" onload="javascript:DrawImage(this,160,160);" title="<?php echo $goods_commend['goods_name'];?>" alt="<?php echo $goods_commend['goods_name'];?>"/></a></span></dd>
...
$(function(){
    ...
    <?php if($output['goods']['goods_state'] == '0' && $output['goods']['goods_show'] == '1'){?>
	$("#nc-bundling").load('index.php?act=goods&op=get_bundling&goods_id=<?php echo $output['goods']['goods_id'];?>&id=<?php echo $output['goods']['store_id'];?>', function(){
		if($('#nc-bundling').html() != ''){
			$('.nc-promotion').show();
			$('#nc-bundling').show();
			$('.nc-bundling-container').F_slider();
		}
	});
	<?php }?>
