    ...
    <!--E 满就送 -->
          ...
          <div class="nc-bundling-goods">
            ...
            <ul nctype="goods_list">
              ...
              <li nctype="nc_li">
                <dl class="goods-info">
                  <dt class="goods-name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods', $output['store_info']['store_domain']);?>" target="block"><?php echo $value['goods_name']?></a></dt>
                  <dd class="goods-pic">
                    <div class="small"><span class="thumb size60"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods', $output['store_info']['store_domain']);?>" target="block"> <img src="<?php echo cthumb($value['goods_image'], 'tiny', $value['store_id']);?>" onload="javascript:DrawImage(this,60,60);"/></a></span> </div>
                    <div class="arrow"></div>
                    <div class="middle"><span class="thumb size160"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods', $output['store_info']['store_domain']);?>" target="block"> <img src="<?php echo cthumb($value['goods_image'], 'small', $value['store_id']);?>" onload="javascript:DrawImage(this,160,160);"/></a></span></div>
                  </dd>
