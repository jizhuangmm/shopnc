...
<div class="ncs-info clearfix">
  <div class="shop-card">
    ...
    <dl>
      <dt><span class="thumb size60"><i></i><a href="<?php echo ncUrl(array('act'=>'show_store','id'=>$output['store_info']['store_id']),'store',$output['store_info']['store_domain']);?>"><img src="<?php if(empty($output['store_info']['store_logo'])){echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_store_logo'];}else{echo ATTACH_STORE.'/'.$output['store_info']['store_logo'];}?>"  onload="javascript:DrawImage(this,60,60);" title="<?php echo $output['store_info']['store_name']; ?>" alt="<?php echo $output['store_info']['store_name']; ?>" /></a></span></dt>
