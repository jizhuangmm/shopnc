            ...
            <ul>
              ...
              <li>
                <dl>
                  ...
                  <dd class="ncg-pic pngFix"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$value['goods_id'],'id'=>$value['store_id']), 'goods');?>" target="_blank" class="thumb"><i></i><img src="<?php echo thumb($value,'small');?>" onload="javascript:DrawImage(this,160,160);" title="<?php echo $value['goods_name'];?>" alt="<?php echo $value['goods_name'];?>" /></a></dd>
