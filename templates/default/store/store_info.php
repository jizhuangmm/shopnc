            ...
            <div class="ncu-intro">
              ...
              <div class="content clearfix">
                ...
                <dl class="ncu-shop-info">
                  <dt><span class="thumb size80"><i></i><a href="<?php echo ncUrl(array('act'=>'show_store','id'=>$output['store_info']['store_id']),'store',$output['store_info']['store_domain']);?>"><img src="<?php if(empty($output['store_info']['store_logo'])){echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_store_logo'];}else{echo ATTACH_STORE.'/'.$output['store_info']['store_logo'];}?>"  onload="javascript:DrawImage(this,80,80);" title="<?php echo $output['store_info']['store_name']; ?>" alt="<?php echo $output['store_info']['store_name']; ?>" /></a></span></dt>
                  <dd class="base">
                ...
                <dl class="nus-contact">
                  ...
                  <?php }?>
                  <?php if($output['store_info']['store_msn'] != ''){?>
                  <dd><?php echo $lang['shoe_store_index_msn'];?><a target="_blank" href="http://settings.messenger.live.com/Conversation/IMMe.aspx?invitee=<?php echo $output['store_info']['store_msn'];?>"><img src="http://messenger.services.live.com/users/<?php echo $output['store_info']['store_msn'];?>/presenceimage/" alt="<?php echo $lang['nc_message_me'];?>" /></a></dd>
                  <?php }?>
                </dl>
              </div>
            </div>
