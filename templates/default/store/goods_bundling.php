...
<div class="nc-bundling-container">
  <div class="F-center">
  <?php foreach($output['bundling_array'] as $val){$i++;?>
  ...
  <ul>
    ...
    <li>
      <dl>
        <dt class="goods-name" title="<?php echo $v['name'];?>"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['id'],'id'=>$v['store_id']), 'goods', $output['store_info']['store_domain']);?>" target="block"><?php echo $v['name'];?></a></dt>
        <dd class="goods-pic"><span class="thumb size100"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['id'],'id'=>$v['store_id']), 'goods', $output['store_info']['store_domain']);?>" target="block"><img src="<?php echo cthumb($v['image'], 'small', $v['store_id'])?>" title="<?php echo $v['name'];?>" alt="<?php echo $v['name'];?>" onload="javascript:DrawImage(this,100,100);" /></a></span></dd>
