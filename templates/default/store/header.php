      ...
      <div class="shop-info-details">
        ...
        <dl class="other">
          ...
          <dd>
            ...
            <?php }?>
            <!-- <?php if(!empty($output['store_info']['store_msn'])){?>
                    <a target="_blank" href="http://settings.messenger.live.com/Conversation/IMMe.aspx?invitee=<?php echo $output['store_info']['store_msn'];?>"><img src="http://messenger.services.live.com/users/<?php echo $output['store_info']['store_msn'];?>/presenceimage/" alt="status" /></a>
					<?php }?> MSN联系方式 --></dd>
        </dl>
      </div>
    </div>
