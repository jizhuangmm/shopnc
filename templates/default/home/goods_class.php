      ...
      <div class="module_sidebar">
        ...
        <ul>
          ...
          <li <?php if($i == 1){?>style=" border:none"<?php }?>>
            <div class="name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']),'goods');?>" target="_blank"><?php echo $val['goods_name'];?></a></div>
            ...
            <div class="info"><span><?php echo $lang['goods_class_already_sale'];?><em><?php echo $val['salenum'];?></em><?php echo $lang['goods_class_index_jian'];?></span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']),'goods');?>" target="_blank"><?php echo $lang['goods_class_go_to_see'];?></a></div>
          </li>
          <?php } ?>
          <?php } ?>
        </ul>
