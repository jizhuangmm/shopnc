...
<div class="mbm warp-all content">
    <div class="left2">
        <div class="group">
            <h1><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$output['groupbuy_info']['goods_id'],'id'=>$output['groupbuy_info']['store_id']), 'goods');?>" target="_blank" title="<?php echo $output['groupbuy_info']['group_name'];?>"><?php echo $output['groupbuy_info']['group_name'];?></a></h1>
            <div class="box"><div class="<?php echo $output['groupbuy_message']['class'];?>"><span><?php echo $lang['currency'];?><?php echo $output['groupbuy_info']['groupbuy_price'];?></span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$output['groupbuy_info']['goods_id'],'id'=>$output['groupbuy_info']['store_id']), 'goods');?>" target="_blank"><?php echo $lang['groupbuy_buy'];?></a></div>
                <div class="info">
                    <div class="prices">
                        <dl>
                ...
                <div class="side-left">
                    ...
                    <div class="buyer"><h3><?php echo $lang['buyer_list'];?></h3><table width="100%" border="0" cellspacing="0" cellpadding="0"><thead><tr>
                            ...
                            <tfoot><tr><td colspan="4">
                                       ...
                                       <a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$output['groupbuy_info']['goods_id'],'id'=>$output['groupbuy_info']['store_id']), 'goods');?>" target="_blank"><em><?php echo $lang['text_buy_now'];?></em></a>
                            </td></tr></tfoot>
                        </table>
                </div></div>
                <div class="store">
                    ...
                    <dl>
                        ...
                        <span class="thumb size120"><i></i>
                            <a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$commend_goods['goods_id'],'id'=>$commend_goods['store_id']), 'goods');?>" target="_blank">
                            <img src="<?php echo thumb($commend_goods,'small')?>" onload="javascript:DrawImage(this,120,120);"></a>
                        </span>
                        </p>
                        <p class="name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$commend_goods['goods_id'],'id'=>$commend_goods['store_id']), 'goods');?>" target="_blank"><?php echo $commend_goods['goods_name'];?></a></p>
