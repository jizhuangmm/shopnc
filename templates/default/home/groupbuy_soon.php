  ...
  <div class="mb10 warp-all group-soon-list">
    ...
    <ul>
      ...
      <li>
        ...
        <div class="btns"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$groupbuy['goods_id'],'id'=>$groupbuy['store_id']), 'goods')?>" target="_blank"><span><?php echo $lang['see_goods'];?></span></a><a href="<?php echo ncUrl(array('act'=>'show_store','id'=>$groupbuy['store_id']), 'store');?>" target="_blank"><span><?php echo $lang['see_store'];?></span></a></div>
      </li>
      <?php } ?>
      <div class="clear"></div>
    </ul>
