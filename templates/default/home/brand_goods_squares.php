  ...
  <ul class="list_pic">
    ...
    <li class="item">
      <dl nctype_goods="<?php echo $goods['goods_id'];?>" nctype_store="<?php echo $goods['store_id'];?>">
        <dt><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domain']);?>" target="_blank" title="<?php echo $goods['goods_name'];?>"><?php echo str_cut($goods['goods_name'],40,'...');?></a></dt>
        <dd class="picture"><span class="thumb"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domain']);?>" target="_blank" title="<?php echo $goods['goods_name'];?>"><img src="<?php echo thumb($goods,'small');?>" onload="javascript:DrawImage(this,160,160);" title="<?php echo $goods['goods_name'];?>" alt="<?php echo $goods['goods_name'];?>"/></a></span></dd>
        <dd class="bargain"><?php echo $lang['brand_index_deal'];?><?php echo $goods['salenum'];?><?php echo $lang['brand_index_jian'];?></dd>
        <!-- S 促销价格显示 -->
        ...
        <dd class="del-price" title="<?php echo $lang['currency'];?><?php echo $goods['goods_store_price'];?>"><?php echo $goods['goods_store_price'];?></dd>
        ...
        <dd class="seller-intro">
          <ul>
            <li><span><?php echo $lang['brand_index_goods_evaluate'].$lang['nc_colon'];?></span><span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domian']);?>#ncGoodsRate"><?php echo $lang['brand_index_comment'];?><?php echo $goods['commentnum'];?><?php echo $lang['brand_index_number_of_consult'];?></a></span></li>
        ...
        <dd class="promotion"><!-- 活动标志 -->
          ...
          <span class="gb" title="<?php echo $lang['brand_index_groupbuy'];?>" style="margin-right:6px;"><?php echo $lang['brand_index_groupbuy'];?></span>
          <?php } ?>
          <?php if(!empty($goods['xianshi_flag'])){ ?>
          <span class="xs" title="<?php echo $lang['brand_index_xianshi'];?>"><?php echo $lang['brand_index_xianshi'];?></span>
          <?php } ?>
        </dd>
      </dl>
    </li>
