...
<div class="<?php echo $output['display_mode'];?>" nc_type="current_display_mode">
  <div class="list-titile"><span class="i1"><?php echo $lang['site_search_goods'];?>&nbsp;/&nbsp;<?php echo $lang['site_search_store'];?></span><span class="i2"><?php echo $lang['goods_class_index_price'];?>&nbsp;/&nbsp;<?php echo $lang['goods_class_index_freight'];?></span><span class="i3"><?php echo $lang['goods_class_index_area'];?></span><span class="i4"><?php echo $lang['goods_class_index_sold'];?>&nbsp;/&nbsp;<?php echo $lang['goods_class_index_comment'];?></span></div>
    ...
    <li class="item">
      <dl nctype_goods="<?php echo $goods['goods_id'];?>" nctype_store="<?php echo $goods['store_id'];?>">
        <dt><!-- 活动标志 -->
          ...
          <em class="promotion"> <span class="gb mr5" title="<?php echo $lang['goods_class_index_groupbuy'];?>"><?php echo $lang['goods_class_index_groupbuy'];?></span></em>
          <?php } ?>
          <?php if(!empty($goods['xianshi_flag'])){ ?>
          <em class="promotion"> <span class="xs" title="<?php echo $lang['goods_class_index_xianshi'];?>"><?php echo $lang['goods_class_index_xianshi'];?></span></em>
          <?php } ?>
          <a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domain']);?>" target="_blank" title="<?php echo $goods['goods_name'];?>"><?php echo $goods['goods_name'];?></a></dt>
        <dd class="pic-layout">
          <div class="picture"><span class="thumb"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domain']);?>" target="_blank"><img src="<?php echo thumb($goods,'tiny');?>" onload="javascript:DrawImage(this,60,60);" alt="<?php echo $goods['goods_name'];?>" /></a></span> </div>
        </dd>
        ...
        <dd class="del-price" title="<?php echo $lang['goods_class_index_normal_goods_price'].$lang['nc_colon'].$lang['currency'];?><?php echo $goods['goods_store_price'];?>"><?php echo $lang['currency'];?><?php echo $goods['goods_store_price'];?></dd>
        ...
        <dd class="del-price" title="<?php echo $lang['goods_class_index_normal_goods_price'].$lang['nc_colon'].$lang['currency'];?><?php echo $goods['goods_store_price'];?>"><?php echo $lang['goods_class_index_normal_goods_price'].$lang['nc_colon']. $lang['currency'];?><?php echo $goods['goods_store_price'];?></dd>
        <?php } else { ?>
        ...
        <dd class="state"><?php echo $lang['goods_class_index_deal'];?><?php echo $goods['salenum'];?><?php echo $lang['goods_class_index_jian'];?></dd>
        <dd class="comment"><span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id'],'id'=>$goods['store_id']),'goods',$goods['store_domian']);?>#ncGoodsRate"><?php echo $lang['goods_class_index_comment'];?><?php echo $goods['commentnum'];?><?php echo $lang['goods_class_index_number_of_consult'];?></a></span></dd>
      </dl>
