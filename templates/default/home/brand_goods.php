  ...
  <div class="group-hot">
            <div class="module_sidebar">
                ...
                <ul>
                    ...
                    <li <?php if($i == 1){?>style=" border:none"<?php }?>><div class="name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']),'goods');?>" target="_blank"><?php echo $val['goods_name'];?></a></div>
                    <div class="box" style="height:168px;width:168px;">
                        ...
                        <div class="mask"></div>
                        <div class="pic" style="height:160px;width:160px;"><span class="thumb" style="height:160px;width:160px;"><i></i><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']),'goods');?>" target="_blank"><img src="<?php echo thumb($val,'small');?>" onload="javascript:DrawImage(this,160,160);"></a></span></div>
                    </div>
                    <div class="info"><span><?php echo $lang['brand_already_sale'];?><em><?php echo $val['salenum'];?></em><?php echo $lang['brand_index_jian'];?></span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']),'goods');?>" target="_blank"><?php echo $lang['brand_go_to_see'];?></a></div>
                    </li>
                    <?php } ?>
                    <?php } ?>
                </ul>
   ...
   <?php }?>
    ...
    <div class="module_sidebar">
      ...
      <ul class="bowers">
        ...
        <li>
          <div class="picture"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods'); ?>"><span class="thumb size60"><i></i><img src="<?php echo thumb($v,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);" title="<?php echo $v['goods_name']; ?>" alt="<?php echo $v['goods_name']; ?>" ></span></a></div>
          <p class="name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods'); ?>"><?php echo $v['goods_name']; ?></a></p>
