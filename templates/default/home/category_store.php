    ...
    <div class="module_sidebar">
      ...
      <div class="wrap">
        <ul class="particular">
          ...
          <li>
            <div class="pic"><i></i><a href="<?php echo ncUrl(array('act'=>'show_store','id'=>$store['store_id']),'store',$store['store_domain']);?>" target="_blank"><img src="<?php echo empty($store['store_logo']) ? ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_store_logo'] : ATTACH_STORE.'/'.$store['store_logo'];?>"  onload="javascript:DrawImage(this,64,64);"/></a></div>
            <dl>
              ...
              <dd><?php echo $lang['category_index_credit'];?>: <?php echo $store['praise_rate'];?>%</dd>
            </dl>
          </li>
          <?php }?>
          <?php }?>
