        ...
        <table class="buy-table">
          ...
          <tbody>
            ...
            <tr id="cart_item_<?php echo $v['spec_id'];?>">
              <td class="w70"><div class="cart-goods-pic"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods');?>" target="_blank"><span class="thumb size60"><i></i><img src="<?php echo thumb($v,'tiny');?>" alt="<?php echo $v['goods_name']; ?>" onload="javascript:DrawImage(this,60,60);" /></span></a></div></td>
              <td class="tl vt"><dl class="cart-goods-info">
                  <dt class="cart-goods-info-name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods');?>" target="_blank"><?php echo $v['goods_name']; ?></a> </dt>
