...
<div class="content">
  ...
  <div class="sale" id="sale">
    <ul class="list_pic">
      ...
      <li class="c1">
        <dl>
          <dt class="goodspic"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods');?>" target="_blank"><img src="<?php echo thumb($v,'small');?>" onload="javascript:DrawImage(this,160,160);" /></a></dt>
          <dd class="goodsname"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']), 'goods');?>" target="_blank" title="<?php echo $v['goods_name'];?>"><?php echo $v['goods_name'];?></a></dd>
          <dd class="price">
