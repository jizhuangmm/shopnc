...
<div class="nc-login-layout">
  <div class="left-pic"><img src="<?php echo TEMPLATES_PATH;?>/images/login_weibo.jpg" /><span><?php echo $output['sinauser_info']['name'];?> </span> </div>
  <div class="nc-login" id="rotate">
    <ul>
      <li><a href="#register_form"><span><?php echo $lang['home_sconnect_register_title']; ?><!-- 完善帐号信息 --></span></a></li>
      <li><a href="#log_form"><span><?php echo $lang['home_sconnect_login_title']; ?><!-- 已有帐号？绑定我的帐号 --></span></a></li>
    </ul>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH; ?>/js/ui.core.js"></script> 
<script type="text/javascript" src="<?php echo RESOURCE_PATH; ?>/js/ui.tabs.js"></script>
