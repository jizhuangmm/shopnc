...
class goodsModel extends Model {
	...
	public function saveGoods($param) {
		...
		$goods_array['goods_indate']			= $param['goods_indate'];
	...
	private function sublistGoods($param) {
		...
		$array['order'] = 'goods.goods_add_time desc,goods.goods_id desc';
	...
	public function getGoodsList($param,$page = '',$field='*') {
		...
		$array['where']	= $condition_str;
		$array['field']	= $field;
		$array['order'] = $param['order'] ? $param['order'] : 'goods.goods_add_time desc';
		$array['join_type']= 'LEFT JOIN';
