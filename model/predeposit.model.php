...
class predepositModel{
	...
	private function getCondition($condition_array){
		...
		//充值状态
		if($condition_array['pdr_state'] != '') {
			$condition_sql	.= " and pdr_state = '".$condition_array['pdr_state']."'";
		}
		//会员姓名
	...
	private function getCashCondition($condition_array){
		...
		//提现状态
		if($condition_array['pdcash_state'] != '') {
			$condition_sql	.= " and pdcash_state = '".$condition_array['pdcash_state']."'";
		}
		//会员编号
