...
echo "')) {\r\n        \$('#list_form').attr('method','post');\r\n        \$('#list_form').attr('action','index.php?act=promotion_mansong&op=mansong_quota_cancel');\r\n        \$('#object_id').val(id);\r\n        \$('#list_form').submit();\r\n    }\r\n}\r\n</script>\r\n\r\n<div class=\"page\">\r\n  <!-- 页面导航 -->\r\n  <div class=\"fixed-bar\">\r\n    <div class=\"item-title\">\r\n      <h3>";
...
if ( is_array( $output['mansong_quota_state_list'] ) )
{
		echo "                  ";
		foreach ( $output['mansong_quota_state_list'] as $key => $val )
		{
				echo "                  <option value=\"";
				echo $key;
				echo "\" ";
...
echo $lang['mansong_quota_list_help1'];
echo "</li>\r\n            <li>";
echo $lang['mansong_quota_list_help2'];
echo "</li>\r\n          </ul></td>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n  <!-- 列表 -->\r\n  <form id=\"list_form\" method=\"post\">\r\n    <input type=\"hidden\" id=\"object_id\" name=\"object_id\"  />\r\n    <table class=\"table tb-type2\">\r\n      <thead>\r\n          <tr class=\"thead\">\r\n              <th class=\"w24\"></th>\r\n              <th class=\"align-left\"><span>";
echo $lang['store_name'];
echo "</span></th>\r\n              <th class=\"align-center\"><span>";
echo $lang['mansong_quota_start_time'];
echo "</span></th>\r\n              <th class=\"align-center\"><span>";
echo $lang['mansong_quota_end_time'];
echo "</span></th>\r\n              <th class=\"align-center\"><span>";
echo $lang['nc_state'];
echo "</span></th>\r\n              <th class=\"align-center\"><span>";
echo $lang['nc_handle'];
...
if ( !empty( $output['list'] ) || is_array( $output['list'] ) )
{
		...
		{
				echo "        <tr class=\"hover\">\r\n            <td><input type=\"checkbox\" name='mansong_quota_checkbox' value=\"";
				echo $val['quota_id'];
				...
				echo "</span></td>\r\n            <td class=\"align-center\"><span>";
				echo $output['mansong_quota_state_list'][$val['state']];
				echo "</span></td>\r\n            <td class=\"nowrap align-center\">\r\n                <!-- 取消按钮 --> \r\n                ";
				if ( intval( $val['state'] ) === intval( $output['mansong_quota_state_activity'] ) )
				{
