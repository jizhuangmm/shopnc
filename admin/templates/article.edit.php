...
echo "\" />\r\n    <table class=\"table tb-type2\">\r\n      <tbody>\r\n        <tr class=\"noborder\">\r\n          <td colspan=\"2\" class=\"required\"><label class=\"validation\" for=\"article_title\">";
echo $lang['article_index_title'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['article_array']['article_title'];
echo "\" name=\"article_title\" id=\"article_title\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label class=\"validation\" for=\"cate_id\">";
...
if ( !empty( $output['parent_list'] ) || is_array( $output['parent_list'] ) )
{
		...
		{
				echo "              <option ";
				if ( $output['article_array']['ac_id'] == $v['ac_id'] )
				{
...
echo "            </select></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"article_url\">";
echo $lang['article_add_url'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['article_array']['article_url'];
echo "\" name=\"article_url\" id=\"article_url\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\">";
echo $lang['article_add_url_tip'];
echo "</td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"if_show\">";
echo $lang['article_add_show'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform onoff\"><label for=\"article_show1\" class=\"cb-enable ";
if ( $output['article_array']['article_show'] == "1" )
{
		echo "selected";
}
echo "\" ><span>";
echo $lang['nc_yes'];
echo "</span></label>\r\n            <label for=\"article_show0\" class=\"cb-disable ";
if ( $output['article_array']['article_show'] == "0" )
{
		echo "selected";
}
echo "\" ><span>";
...
echo "  value=\"1\" type=\"radio\">\r\n            <input id=\"article_show0\" name=\"article_show\" ";
if ( $output['article_array']['article_show'] == "0" )
{
		echo "checked=\"checked\"";
}
...
echo $lang['nc_sort'];
echo ":</td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['article_array']['article_sort'];
echo "\" name=\"article_sort\" id=\"article_sort\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label class=\"validation\">";
echo $lang['article_add_content'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td colspan=\"2\" class=\"vatop rowform\">";
showeditor( "article_content", $output['article_array']['article_content'] );
echo "</td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\">";
