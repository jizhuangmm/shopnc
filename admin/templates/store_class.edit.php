...
echo $output['class_array']['sc_id'];
echo "\" />\r\n    <table class=\"table tb-type2\">\r\n      <tbody>\r\n        <tr class=\"noborder\">\r\n          <td colspan=\"2\" class=\"required\"><label class=\"validation\" class=\"sc_name\">";
echo $lang['store_class_name'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['class_array']['sc_name'];
echo "\" name=\"sc_name\" id=\"sc_name\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr><!--\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"parent_id\">";
...
if ( !empty( $output['parent_list'] ) || is_array( $output['parent_list'] ) )
{
		...
		{
				echo "              <option ";
				if ( $output['class_array']['sc_parent_id'] == $v['sc_id'] )
				{
...
echo "            </select></td>\r\n          <td class=\"vatop tips\">";
echo $lang['store_class_notice2'];
echo "</td>\r\n        </tr>\r\n        --><tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"sc_sort\">";
echo $lang['nc_sort'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['class_array']['sc_sort'];
echo "\" name=\"sc_sort\" id=\"sc_sort\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\">";
