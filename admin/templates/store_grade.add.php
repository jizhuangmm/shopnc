...
echo "(MB):</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"\" id=\"sg_space_limit\" name=\"sg_space_limit\" class=\"txt\">\r\n\t\t\t<label class=\"field_notice\">";
echo $lang['zero_said_no_limit'];
echo "</label>      </td>\r\n\t\t</tr>-->\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"skin_limit\">";
echo $lang['optional_template_num'];
echo ":</label>\r\n            </label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><span class=\"grey\">(";
...
echo $lang[''];
echo "</label></li>-->\r\n              <!--\r\n              <li>\r\n                <input type=\"checkbox\" id=\"function_groupbuy\" value=\"groupbuy\" name=\"sg_function[]\">\r\n                <label for=\"function_groupbuy\">";
...
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform onoff\"><label for=\"sg_confirm1\" class=\"cb-enable selected\" ><span>";
echo $lang['nc_yes'];
echo "</span></label>\r\n            <label for=\"sg_confirm0\" class=\"cb-disable \" ><span>";
echo $lang['nc_no'];
echo "</span></label>\r\n            <input id=\"sg_confirm1\" name=\"sg_confirm\" checked=\"checked\" value=\"1\" type=\"radio\">\r\n            <input id=\"sg_confirm0\" name=\"sg_confirm\" value=\"0\" type=\"radio\"></td>\r\n          <td class=\"vatop tips\">";
echo $lang['need_audit_notice'];
echo "</td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"sg_description\">";
