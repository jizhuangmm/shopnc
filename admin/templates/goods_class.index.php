...
echo "</span></a></li>\r\n        <li><a href=\"index.php?act=goods_class&op=goods_class_tag\" ><span>";
...
echo $lang['goods_class_index_help1'];
echo "</li>\r\n            <li>";
echo $lang['goods_class_index_help2'];
...
if ( !empty( $output['class_list'] ) || is_array( $output['class_list'] ) )
{
		...
		{
				echo "        <tr class=\"hover edit\">\r\n          <td class=\"w48\"><input type=\"checkbox\" name=\"check_gc_id[]\" value=\"";
				echo $v['gc_id'];
				...
				echo $v['gc_name'];
				echo "</span>\r\n          <a class=\"btn-add-nofloat marginleft\" href=\"index.php?act=goods_class&op=goods_class_add&gc_parent_id=";
				echo $v['gc_id'];
				echo "\"><span>";
				...
				echo "</td>\r\n          <td class=\"w84\"><a href=\"index.php?act=goods_class&op=goods_class_edit&gc_id=";
				echo $v['gc_id'];
				echo "\">";
				echo $lang['nc_edit'];
				echo "</a> | <a href=\"javascript:if(confirm('";
				echo $lang['goods_class_index_ensure_del'];
				echo "'))window.location = 'index.php?act=goods_class&op=goods_class_del&gc_id=";
				echo $v['gc_id'];
				echo "';\">";
				echo $lang['nc_del'];
				echo "</a></td>\r\n        </tr>\r\n        ";
