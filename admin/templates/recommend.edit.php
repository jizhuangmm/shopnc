...
echo $output['recommend_array']['recommend_id'];
...
echo $output['recommend_array']['recommend_name'];
echo "\" id=\"recommend_name\" name=\"recommend_name\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\">";
echo $lang['recommend_index_type_name'];
echo "</td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label class=\"validation\" for=\"css_class\">";
echo $lang['recommend_css_class'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['config_array']['css_class'];
echo "\" id=\"css_class\" name=\"css_class\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\">";
...
echo "\" name=\"width\" id=\"width\" class=\"txt2\">\r\n            -&nbsp;&nbsp;\r\n            <input type=\"text\" value=\"";
...
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><input type=\"text\" value=\"";
echo $output['config_array']['limit'];
echo "\" name=\"limit\" id=\"limit\" class=\"txt\"></td>\r\n          <td class=\"vatop tips\">";
...
echo "</textarea></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr>\r\n        <tr>\r\n          <td colspan=\"2\" class=\"required\"><label for=\"recommend_http\">";
echo $lang['recommend_http'];
echo ":</label></td>\r\n        </tr>\r\n        <tr class=\"noborder\">\r\n          <td class=\"vatop rowform\"><textarea rows=\"6\" class=\"tarea\" id=\"recommend_http\" readonly=\"readonly\" onclick=\"this.select()\"><script type=\"text/javascript\" src=\"";
echo SiteUrl;
echo "/api/goods/index.php?id=";
echo $output['recommend_array']['recommend_id'];
echo "\"></script></textarea></td>\r\n          <td class=\"vatop tips\"></td>\r\n        </tr>\r\n      </tbody>\r\n      <tfoot>\r\n        <tr class=\"tfoot\">\r\n          <td colspan=\"15\"><a href=\"JavaScript:void(0);\" class=\"btn\" id=\"submitBtn\"><span>";
echo $lang['nc_submit'];
