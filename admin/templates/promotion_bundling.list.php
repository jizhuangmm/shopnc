...
echo $lang['bundling_name'];
echo "</label></th>\r\n          <td><input type=\"text\" value=\"";
echo $output['bundling_name'];
echo "\" name=\"bundling_name\" id=\"bundling_name\" class=\"txt\" style=\"width:100px;\"></td>\r\n          <th><label for=\"store_name\">";
echo $lang['bundling_quota_store_name'];
echo "</label></th>\r\n          <td><input type=\"text\" value=\"";
echo $output['store_name'];
...
echo $lang['bundling_quota_prompts'];
echo "</li>\r\n          </ul></td>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n  <!-- 列表 -->\r\n  <form id=\"list_form\" method=\"post\">\r\n    <input type=\"hidden\" id=\"object_id\" name=\"object_id\"  />\r\n    <table class=\"table tb-type2\">\r\n      <thead>\r\n        <tr class=\"thead\">\r\n          <th>";
echo $lang['bundling_quota_store_name'];
echo "</th>\r\n          <th class=\"align-center\">";
echo $lang['bundling_name'];
echo "</th>\r\n          <th class=\"align-center\">";
echo $lang['bundling_price'];
echo "</th>\r\n          <th class=\"align-center\">";
echo $lang['bundling_goods_count'];
echo "</th>\r\n          <th class=\"align-center\">";
echo $lang['nc_status'];
echo "</th>\r\n          <th class=\"align-center\">";
echo $lang['nc_handle'];
...
if ( !empty( $output['list'] ) || is_array( $output['list'] ) )
{
		...
		foreach ( $output['list'] as $k => $val )
		{
				...
				echo $val['bl_name'];
				echo "</td>\r\n          <td class=\"align-center\">";
				echo $val['bl_discount_price'];
				echo "</td>\r\n          <td class=\"align-center\">";
				echo $val['count'];
				echo "</td>\r\n          <td class=\"align-center yes-onoff\">\r\n            <a href=\"JavaScript:void(0);\" class=\"tooltip ";
				echo $val['bl_state'] ? "enabled" : "disabled";
				echo "\" ajax_branch=\"bl_state\" nc_type=\"inline_edit\"  fieldname=\"bl_state\" fieldid=\"";
				echo $val['bl_id'];
				echo "\" fieldvalue=\"";
				echo $val['bl_state'] ? "1" : "0";
				echo "\" title=\"";
				...
				echo SiteUrl;
				echo "/index.php?act=bundling&bundling_id=";
				echo $val['bl_id'];
				echo "&id=";
				echo $val['store_id'];
				echo "\">";
