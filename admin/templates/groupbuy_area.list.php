...
echo $lang['groupbuy_area_help1'];
echo "</li>\r\n          </ul></td>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n  <form id=\"list_form\" method='post'>\r\n    <input id=\"area_id\" name=\"area_id\" type=\"hidden\" />\r\n    <table class=\"table tb-type2\">\r\n      <thead>\r\n        \r\n        <tr class=\"thead\">\r\n          <th></th>\r\n          <th>";
echo $lang['nc_sort'];
echo "</th>\r\n          <th>";
echo $lang['goods_area_index_name'];
...
if ( !empty( $output['list'] ) || is_array( $output['list'] ) )
{
		...
		foreach ( $output['list'] as $val )
		{
				...
				echo $val['area_parent_id'] == "0" ? "" : "two";
				echo " ";
				echo "parent".$val['area_parent_id'];
				...
				echo "\" ajax_branch=\"area_sort\" datatype=\"number\" fieldid=\"";
				echo $val['area_id'];
				...
				if ( $val['deep'] == "2" )
				{
						echo "            <img src=\"templates/images/vertline.gif\" class=\"preimg\"> <img fieldid=\"";
						echo $val['area_id'];
						echo "\" status=\"close\" nc_type=\"flex\" src=\"";
						echo TEMPLATES_PATH;
						echo "/images/tv-expandable1.gif\">\r\n            ";
				}
				echo "            <span title=\"";
				echo $lang['nc_editable'];
				echo "\" required=\"1\" fieldid=\"";
				echo $val['area_id'];
				echo "\" ajax_branch=\"area_name\" fieldname=\"area_name\" nc_type=\"inline_edit\" class=\"node_name editable tooltip\">";
				echo $val['area_name'];
				echo "</span>\r\n            ";
				if ( $val['node'] != "1" )
				{
						echo "            <a class=\"btn-add-nofloat marginleft\" href=\"index.php?act=groupbuy&op=area_add&parent_id=";
						echo $val['area_id'];
						echo "\"><span>";
						echo $lang['nc_add_sub_class'];
						echo "</span></a>\r\n            ";
				}
				echo "</td>\r\n        <td class=\"w156 align-center\">\r\n        <!--\r\n            <a href=\"index.php?act=groupbuy&op=area_edit&area_id=";
				echo $val['area_id'];
				echo "\">";
				echo $lang['nc_edit'];
...
if ( !empty( $output['list'] ) || is_array( $output['list'] ) )
{
		...
		echo "</label>\r\n            </span>&nbsp;&nbsp; <a href=\"JavaScript:void(0);\" onClick=\"submit_delete_batch();\" class=\"btn\"><span>";
		echo $lang['nc_del'];
		echo "</span></a>\r\n        </tr>\r\n      </tfoot>\r\n      ";
}
