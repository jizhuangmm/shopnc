...
public function __construct(){
		...
		public function mansong_apply_verifyOp( )
		{
				...
				$member_info = $model_member->infoMember( array(
						"member_id" => $mansong_apply['member_id']
				) );
		...
		public function mansong_listOp( )
		{
				...
				$model_mansong->update( array(
						"state" => self::MANSONG_STATE_END
				), array(
						"greater_than_end_time" => time( ),
						"state" => self::MANSONG_STATE_PUBLISHED
				) );
				$page = new Page( );
				$page->setEachNum( 10 );
				$page->setStyle( "admin" );
		...
		private function show_menu( $menu_key )
		{
				$menu_array = array(
						"mansong_apply" => array(
								"menu_type" => "link",
								"menu_name" => Language::get( "mansong_apply" ),
								"menu_url" => "index.php?act=promotion_mansong&op=mansong_apply"
						),
						"mansong_quota" => array(
								"menu_type" => "link",
								"menu_name" => Language::get( "mansong_quota" ),
								"menu_url" => "index.php?act=promotion_mansong&op=mansong_quota"
						),
						"mansong_list" => array(
								"menu_type" => "link",
								"menu_name" => Language::get( "mansong_list" ),
								"menu_url" => "index.php?act=promotion_mansong&op=mansong_list"
						),
						"mansong_detail" => array(
								"menu_type" => "link",
								"menu_name" => Language::get( "mansong_detail" ),
								"menu_url" => "index.php?act=promotion_mansong&op=mansong_detail"
						),
						"mansong_setting" => array(
								"menu_type" => "link",
								"menu_name" => Language::get( "mansong_setting" ),
								"menu_url" => "index.php?act=promotion_mansong&op=mansong_setting"
						)
				);
