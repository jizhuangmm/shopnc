...
$lang['admin_index_add_succ'] = "新增管理员成功";
$lang['admin_index_add_fail'] = "新增管理员失败";
$lang['admin_index_add_allow'] = "请设置管理员权限";
$lang['admin_index_not_allow_del'] = "该帐号为系统管理员,不得删除";
$lang['admin_index_login_null'] = "此管理员未登录过";
$lang['admin_index_del_succ'] = "删除管理员成功";
$lang['admin_index_choose'] = "请选择要删除的内容";
$lang['admin_index_admin_manage'] = "管理员管理";
$lang['admin_index_username'] = "用户名";
$lang['admin_inde_password'] = "密码";
...
$lang['admin_index_edit_right'] = "编辑权限";
$lang['admin_index_del_admin'] = "删除";
$lang['admin_index_sys_admin_no'] = "超级管理员不可编辑";
$lang['admin_add_admin_not_exists'] = "该管理员名称已存在";
$lang['admin_add_username_tip'] = "首先输入您要添加的管理员用户名";
$lang['admin_add_password_tip'] = "首先输入您要添加的管理员密码";
$lang['admin_add_username_null'] = "用户名不能为空";
$lang['admin_add_username_max'] = "用户名长度为3-20";
$lang['admin_add_password_null'] = "密码不能为空";
$lang['admin_add_password_type'] = "密码为英文或数字";
$lang['admin_add_password_max'] = "密码长度为6-20";
$lang['admin_add_username_not_exists'] = "该用户名不存在，请换一个";
$lang['admin_set_admin_not_exists'] = "此管理员不存在";
$lang['admin_set_assign_right'] = "请您分配权限";
$lang['admin_set_back_to_admin_list'] = "返回管理员列表";
$lang['admin_set_back_to_member_list'] = "返回会员列表";
$lang['admin_set_add_succ'] = "添加管理员成功。";
$lang['admin_set_edit_fail'] = "管理员编辑失败。";
$lang['admin_set_edit_succ'] = "管理员编辑成功。";
$lang['admin_set_right_manage'] = "权限管理";
