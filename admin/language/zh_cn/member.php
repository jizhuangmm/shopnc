...
$lang['member_index_del_succ'] = "删除会员成功";
$lang['member_index_choose_del'] = "请选择要删除的内容";
$lang['member_index_manage'] = "会员管理";
$lang['member_index_name'] = "会员名";
...
$lang['member_index_help3'] = "可用金额，会员可以用来支付，和提现的金额";
$lang['member_index_help4'] = "冻结金额，当会员进行提现操作后，提现金额变为冻结金额等待管理员审核操作。当会员使用预存款支付购买时，在订单支付后且未收货之前，可用金额减少，支付的金额变为冻结金额，直到确认收货后，冻结金额减少，卖家可用金额增加。冻结金额不能用来支付或提现";
...
$lang['member_edit_msn_wrong'] = "请输入正确的MSN号码";
