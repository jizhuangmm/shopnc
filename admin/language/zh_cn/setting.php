...
$lang['upload_set_base'] = "基本设置";
$lang['upload_set_ftp'] = "远程图片";
$lang['upload_pic_base'] = "图片设置";
$lang['point_set'] = "积分设置";
$lang['manage_about'] = "管理相关";
...
$lang['open_pseudo_static_increase_search'] = "启用伪静态可以提高搜索引擎抓取";
$lang['open_kefu'] = "启用在线客服";
$lang['open_kefu_yes'] = "是";
$lang['open_kefu_no'] = "否";
$lang['setting_off'] = "关闭";
$lang['setting_on'] = "开启";
$lang['promotion_allow'] = "是否开启商品促销功能";
$lang['promotion_notice'] = "启用商品促销功能后，卖家可以通过限时打折和满即送活动，对店铺商品进行促销";
$lang['open_pointshop_isuse'] = "是否开启积分中心";
$lang['open_pointshop_isuse_notice'] = "积分中心和积分同时启用后，网站将增加积分中心频道。您可以进入“<a href=\"%s\">积分中心</a>”进行相关设置";
$lang['open_pointprod_isuse'] = "是否开启积分兑换";
...
$lang['open_pointprod_no'] = "关闭";
$lang['open_pointprod_yes'] = "开启";
$lang['open_predeposit_isuse'] = "是否启用预存款";
$lang['open_predeposit_isuse_notice'] = "预存款启用后，会员可以给自己帐户充值进行交易，加强平台对资金的管理";
$lang['open_predeposit_no'] = "关闭";
$lang['open_predeposit_yes'] = "开启";
$lang['voucher_allow'] = "是否启用代金券";
$lang['voucher_allow_notice'] = "代金券功能、积分功能、金币功能、积分中心启用后，卖家可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属店铺内购买商品时，选择使用而得到优惠";
$lang['voucher_allow_no'] = "关闭";
$lang['voucher_allow_yes'] = "开启";
$lang['groupbuy_allow'] = "是否启用团购";
$lang['groupbuy_allow_no'] = "关闭";
$lang['groupbuy_allow_yes'] = "开启";
$lang['groupbuy_isuse_notice'] = "团购功能启用后，平台可以发布团购活动，商家通过活动发布团购商品，进行促销";
$lang['flea_allow'] = "开启闲置市场";
$lang['complain_time_limit'] = "投诉时效";
$lang['complain_time_limit_desc'] = "单位为天，订单完成后开始计算，多少天内可以发起投诉，根据具体情况卖家和买家都可发起投诉";
$lang['open_apache'] = "启用前，请先确保已开启apache服务器的";
$lang['module'] = "功能模块，并将商城目录下的";
$lang['file_re_name'] = "文件重命名为";
$lang['next_choose_yes'] = "，然后选择“是”，保存即可。";
...
$lang['setting_store_creditrule'] = "信用额度";
...
$lang['first_integration'] = "<span>如果是第一次整合Ucenter或PHPWind，</span><span style=\" color: #F00;\">需要</span><span style=\" color: #F00;\">清除商城会员</span><span>信息，清除前建议您备份数据</span>";
$lang['click_bak'] = "点击备份";
$lang['ucenter_type'] = "请选择整合的社区系统";
$lang['ucenter_uc_discuz'] = "Ucenter";
$lang['ucenter_uc_phpwind'] = "PHPWind 8.7";
...
$lang['ucenter_application_id_tips'] = "ShopNC商城系统在若整合Ucenter或若整合PHPWind中的应用ID";
$lang['ucenter_address_tips'] = "若整合Ucenter，需要填写Ucenter的访问地址;若整合PHPWind，填写PHPWind访问地址即可";
...
$lang['upload_goods_image_size_tiny'] = "商品微图尺寸";
$lang['upload_goods_image_size_tiny_tips'] = "设定生成商品微图的尺寸，单位为像素。";
$lang['upload_goods_image_size_small'] = "商品小图尺寸";
$lang['upload_goods_image_size_small_tips'] = "设定生成商品小图的尺寸，单位为像素。";
$lang['upload_goods_image_size_medium'] = "商品中图尺寸";
$lang['upload_goods_image_size_medium_tips'] = "设定生成商品中图的尺寸，单位为像素。";
$lang['upload_goods_image_size_large'] = "商品大图尺寸";
$lang['upload_goods_image_size_large_tips'] = "设定生成商品大图的尺寸，单位为像素。";
$lang['gold_isuse'] = "是否启用金币";
...
$lang['edit_ztc_set_ok'] = "设置成功。";
$lang['edit_ztc_set_fail'] = "设置失败。";
$lang['backstage_login'] = "后台登录";
...
$lang['qq_update_success'] = "更新成功";
$lang['qq_update_fail'] = "更新失败";
...
$lang['sina_update_success'] = "更新成功";
$lang['sina_update_fail'] = "更新失败";
$lang['sina_function_fail_tip'] = "该功能需要在  php.ini 中 开启 php_curl 扩展，才能使用。";
$lang['points_isuse'] = "是否启用积分";
...
$lang['open_no'] = "否";
$lang['font_set'] = "水印字体";
$lang['font_download'] = "字体库下载";
$lang['font_help1'] = "如果图片空间中水印使用汉字则要下载并安装相应字体库。";
$lang['font_help2'] = "使用方法：将您下载到的字体库上传到网站根目录下\\resource\\font这个文件夹内，同时需要修改此文件夹下的font.info.php文件。例如：您下载了一个“宋体”字库simsun.ttf，将其放置于前面所述文件夹内，打开font.info.php文件在其中的\$fontInfo = array('arial'=>'Arial')数组后面添加宋体字库信息,“=>”符号左边是文件名，右边是您想在网站上显示的文字信息，添加后的样子是array('arial'=>'Arial','simsun'=>'宋体')";
...
$lang['memory_set_opt'] = "内存优化";
$lang['memory_set_prompt1'] = "启用内存优化功能将会大幅度提升程序性能和服务器的负载能力，内存优化功能需要服务器系统以及PHP扩展模块支持";
$lang['memory_set_prompt2'] = "目前支持的内存优化接口有 Memcache、eAccelerator、Alternative PHP Cache(APC)、Xcache 四种，系统将会依据当前服务器环境选用接口";
...
$lang['memory_set_cur_status'] = "当前内存工作状态";
$lang['memory_set_type'] = "内存类型";
...
$lang['fulltext_set'] = "Sphinx 全文检索设置";
$lang['fulltext_set_prompt1'] = "启用全文检索功能将会大幅提高商城搜索响应速度，Sphinx全文检索功能需要服务器系统支持";
$lang['fulltext_set_prompt2'] = "Sphinx全文检索接口的主要设置位于网站根目录 config.ini.php 当中，您可以使用EditPlus（禁止使用记事本、写字板）通过编辑 config.ini.php 进行高级设置";
$lang['fulltext_set_prompt3'] = "该系统支持“实时索引更新”，当数据集非常大，以至于难于经常性的重建索引，但是每次新增的记录却相当地少的情况下可以使用“实时索引更新”的配置方式，具体配置信息请参照“readme/sphinx实时索引更新.conf”文档";
?>
