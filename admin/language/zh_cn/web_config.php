...
$lang['web_config_edit_help1'] = "所有相关设置完成，使用底部的“更新板块内容”前台展示页面才会变化，活动图片、广告图片可以选择调用广告。";
$lang['web_config_edit_help2'] = "左侧的“推荐分类”没有个数限制，但是如果太多会不显示(已选择的子分类可以拖动进行排序，单击选中，双击删除)。";
$lang['web_config_edit_help3'] = "中部的“商品推荐模块”由于页面宽度只能加3个，商品数为6个；右侧的排行个数为7个；底部的品牌最多为8个(已选择的可以拖动进行排序，单击选中，双击删除)。";
...
$lang['web_config_recommend_max'] = "(最多3个)";
...
$lang['web_config_upload_tit_tips'] = "建议上传210*72像素GIF\\JPG\\PNG格式图片，超出规定范围的图片部分将被自动隐藏。";
...
$lang['web_config_prompt_act'] = "请按照操作注释要求，上传设置板块区域左下角的活动图片。";
$lang['web_config_upload_type'] = "选择类型";
$lang['web_config_upload_pic'] = "图片上传";
$lang['web_config_upload_adv'] = "广告调用";
$lang['web_config_upload_act_tips'] = "建议上传208*128像素GIF\\JPG\\PNG格式图片，超出规定范围的图片部分将被自动隐藏。";
$lang['web_config_upload_act_url'] = "输入点击该图片后所要跳转的链接地址。";
$lang['web_config_upload_act_adv'] = "调用条件为：已启用、宽度208像素、高度128像素、图片类广告。";
...
$lang['web_config_recommend_goods_tips'] = "小提示：单击查询出的商品选中，双击已选择的可以删除，最多6个，保存后生效。";
...
$lang['web_config_goods_list_tips'] = "小提示：单击查询出的商品选中，双击已选择的可以删除，最多7个，保存后生效。";
...
$lang['web_config_brand_tips'] = "小提示：单击候选品牌选中，双击已选择的可以删除，最多8个，保存后生效。";
...
$lang['web_config_upload_pic_tips'] = "建议上传210*100像素GIF\\JPG\\PNG格式图片，超出规定范围的图片部分将被自动隐藏。";
$lang['web_config_upload_adv_url'] = "广告跳转链接";
$lang['web_config_upload_pic_url_tips'] = "输入点击该图片后所要跳转的链接地址";
$lang['web_config_adv_url_tips'] = "调用条件为：已启用、宽度210像素、高度100像素、图片类广告。";
?>
