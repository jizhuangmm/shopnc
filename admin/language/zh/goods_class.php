...
$lang['goods_class_edit_prompts_three'] = "在編輯\"類型\"和勾選\"關聯到子分類\"時，涉及分類下的商品將會被進行\"違規下架\"處理，商品在重新編輯後才能正常使用，<span style=\"color:#F30\">請慎重操作</span>。";
$lang['goods_class_edit_related_to_subclass'] = "關聯到子分類";
$lang['goods_class_edit_goods_close_reason'] = "分類或規格信息不符";
...
$lang['goods_class_tag_prompts_one'] = "商品分類TAG對應商品發佈第一步“選擇商品分類”的分類搜索功能。方便商家快速準確的找到所需的商品分類。";
...
$lang['goods_class_reset_tag_fail'] = "重置TAG失敗。";
$lang['goods_class_reset_tag_fail_no_class'] = "重置TAG失敗，沒查找到任何分類信息。";
$lang['goods_class_update_tag_succ'] = "TAG名稱更新成功。";
$lang['goods_class_update_tag_fail'] = "TAG名稱更新失敗。";
$lang['goods_class_update_tag_fail_no_class'] = "TAG名稱更新失敗，沒查找到任何分類信息。";
$lang['goods_class_tag_del_succ'] = "TAG刪除成功。";
$lang['goods_class_tag_del_fail'] = "TAG刪除失敗。";
