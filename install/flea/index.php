...
if ($version != '20121027'){
	...
	echo "已经安装完成或版本错误，本程序只适用于“ShopNC 2.3”的系统。";
	exit;
}
...
<title>ShopNC 2.2闲置市场功能安装程序</title>
...
<div class="container">
	...
	<table class="menu">
			...
			<tr>
				...
				<?php if ($current == ''){ ?>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重要说明：本安装包仅针对ShopNC商城系统2.3版本添加闲置市场功能的安装，不包含在原有1.X版本基础上添加闲置市场功能。请在安装前提前做好备份工作，对于在原有系统进行过二次开发的客户，在安装中请注意对于修改过文件的备份及调整。否则直接安装可能会导致系统不能正常运行或页面出现不正常等情况。<span style="color: #FF0000;">如因安装造成您原有二次开发功能的错误或丢失，官方不予承担任何责任及损失，请您慎重操作。
				</span><br /><br />
		...
		<div class="footer"><p>Powered by <a href="http://www.shopnc.net" target="_blank">ShopNC </a>© v2.3 2007-2012 <a href="http://www.shopnc.net" target="_blank">网城创想</a> Inc.</p>
