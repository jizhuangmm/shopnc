...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='活动表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='活动细节表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='买家地址信息表';
...
CREATE TABLE `#__adv` (
  ...
  PRIMARY KEY  (`adv_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='广告表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='广告点击率表';
...
CREATE TABLE `#__adv_position` (
  ...
  PRIMARY KEY (`ap_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='广告位表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='相册表';
...
CREATE TABLE `#__album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY  (`apic_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='相册图片表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品属性表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品属性值表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='品牌表';

CREATE TABLE `#__cache_store` (
  `store_id` mediumint(8) unsigned NOT NULL COMMENT '店铺ID',
  `num_sales` mediumint(8) unsigned NOT NULL default '0' COMMENT '店铺总销量',
  `num_selling` mediumint(8) unsigned NOT NULL default '0' COMMENT '上架在售的商品数',
  `num_storage` mediumint(8) unsigned NOT NULL default '0' COMMENT '仓库中待上架的商品数',
  `num_wg` mediumint(8) unsigned NOT NULL default '0' COMMENT '违规下架的商品',
  `num_ordering` mediumint(8) unsigned NOT NULL default '0' COMMENT '交易中的订单',
  `num_accused` mediumint(8) unsigned NOT NULL default '0' COMMENT '被投诉数',
  `num_sales_jq` mediumint(8) unsigned NOT NULL default '0' COMMENT '近期售出(三个月内)',
  `num_collect` mediumint(8) unsigned NOT NULL default '0' COMMENT '被收藏数',
  `goods_str1` varchar(200) NOT NULL default '' COMMENT '店铺列表8个展示商品',
  PRIMARY KEY  (`store_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺信息缓存表';
...
CREATE TABLE `#__cart` (
  ...
  PRIMARY KEY  (`cart_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='购物车数据表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='投诉表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='投诉商品表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='举报主题表';
...
CREATE TABLE `#__complain_talk` (
  ...
  PRIMARY KEY (`talk_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='投诉对话表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='产品咨询表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='优惠券';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='优惠券分类';
...
CREATE TABLE `#__daddress` (
  ...
  PRIMARY KEY  (`address_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='卖家发货地址信息表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='系统文章表';
...
CREATE TABLE `#__evaluate_goods` (
  ...
  `geval_orderno` varchar(100) NOT NULL COMMENT '订单编号',
  ...
  `geval_content` varchar(500) default NULL COMMENT '信誉评价内容',
  ...
  `geval_remark` varchar(500) default NULL COMMENT '管理员对评价的处理备注',
  `geval_explain` varchar(500) default NULL COMMENT '解释内容',
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='信誉评价表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品评价统计表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺评分表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺评价统计表';
...
CREATE TABLE `#__express` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='快递公司';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='买家收藏表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='访问量统计表';
...
CREATE TABLE `#__gold_buy` (
  ...
  PRIMARY KEY  (`gbuy_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='金币购买记录表';
...
CREATE TABLE `#__gold_log` (
  ...
  PRIMARY KEY  (`glog_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='金币日志表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='金币支付方式表';
...
CREATE TABLE `#__goods` (
  ...
  `goods_image_more` text default NULL COMMENT '商品多图',
  ...
  `goods_attr` text default '' COMMENT '商品属性',
  `goods_spec` text default '' COMMENT '商品规格',
  `goods_col_img` text default NULL COMMENT '颜色自定义图片',
  ...
  KEY `store_id` (`store_id`),
  KEY `gc_id` (`gc_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品与属性对应表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品分类表';
...
CREATE TABLE `#__goods_class_staple` (
  ...
  PRIMARY KEY (`staple_id`),
	KEY `store_id` (`store_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品分类TAG表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='团购商品表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品规格表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品与规格对应表';
...
CREATE TABLE  `#__groupbuy_area` (
	...
	PRIMARY KEY (`area_id`)
) ENGINE=MYISAM  DEFAULT CHARSET=gbk COMMENT='团购地区表';
...
CREATE TABLE `#__groupbuy_class` (
  ...
  PRIMARY KEY (`class_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='团购类别表';
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='团购价格区间表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='团购活动表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='举报表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='举报类型表';
...
CREATE TABLE `#__link` (
  ...
  PRIMARY KEY (`link_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='合作伙伴表';
...
CREATE TABLE `#__mail_msg_temlates` (
  ...
  PRIMARY KEY (`code`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='邮件模板表';
...
CREATE TABLE `#__map` (
  ...
  PRIMARY KEY  (`map_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='地图表';
...
CREATE TABLE `#__navigation` (
  ...
  PRIMARY KEY (`nav_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='页面导航表';
...
CREATE TABLE `#__order_address` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='订单配送信息表';
...
CREATE TABLE `#__order_goods` (
  ...
  `goods_returnnum` int(10) unsigned NULL DEFAULT '0' COMMENT '退货数量',
...
CREATE TABLE `#__order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='订单处理历史表';
...
CREATE TABLE `#__payment` (
  ...
  PRIMARY KEY (`payment_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺支付接口数据表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='积分礼品兑换购物车';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='积分礼品表';
...
CREATE TABLE `#__points_log` (
	...
	PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='会员积分日志表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='兑换订单表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='兑换订单地址表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='兑换订单商品表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='预存款提现记录表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='预存款日志表';
...
CREATE TABLE `#__predeposit_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='预存款充值信息表';
...
CREATE TABLE `#__p_bundling` (
  ...
  PRIMARY KEY  (`bl_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='组合销售活动表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='组合销售活动商品表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='组合销售套餐表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='满就送活动表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='满就送套餐申请表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='满就送套餐表';
...
CREATE TABLE `#__p_mansong_rule` (
  ...
  PRIMARY KEY (`rule_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='满就送活动规则表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='限时折扣活动表';
...
CREATE TABLE `#__p_xianshi_apply` (
  ...
  `state` tinyint(1) unsigned NOT NULL COMMENT '状态(1-新申请/2-审核通过/3-已取消/4-审核失败)',
  PRIMARY KEY  (`apply_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='限时折扣套餐申请表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='限时折扣商品表';
...
CREATE TABLE `#__p_xianshi_quota` (
  ...
  `state` tinyint(1) unsigned NOT NULL COMMENT '配额状态(1-可用/2-取消/3-结束)',
  PRIMARY KEY  (`quota_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='限时折扣套餐表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='推荐类型表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='推荐商品表';
...
CREATE TABLE `#__refund_log` (
  ...
  PRIMARY KEY  (`log_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='退款表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='退货表';
...
CREATE TABLE `#__return_goods` (
  ...
  `goods_image` varchar(100) default NULL COMMENT '商品图片',
  PRIMARY KEY  (`log_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='退货商品表';
...
CREATE TABLE `#__salenum` (
  ...
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID'
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='销量统计表';
...
CREATE TABLE `#__seo` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='SEO信息存放表';

CREATE TABLE `#__setting` (
  `name` varchar(50) NOT NULL COMMENT '名称',
  `value` text COMMENT '值',
  PRIMARY KEY  (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='系统设置表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='分享应用用户绑定记录表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='好友数据表';
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='SNS商品表';
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='共享商品表';
...
CREATE TABLE `#__sns_sharestore` (
  ...
  `share_privacy` tinyint(1) NOT NULL default '0' COMMENT '隐私可见度 0所有人可见 1好友可见 2仅自己可见',
  PRIMARY KEY  (`share_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='共享店铺表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='动态信息表';
...
CREATE TABLE `#__sns_visitor` (
  ...
  PRIMARY KEY  (`v_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='sns访客表';
...
CREATE TABLE `#__spec` (
  ...
  PRIMARY KEY  (`sp_id`)
) ENGINE = MYISAM CHARSET=gbk COMMENT='商品规格表';
...
) ENGINE = MYISAM CHARSET=gbk COMMENT='商品规格值表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺数据表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺分类表';

CREATE TABLE `#__store_class_goods` (
  `stc_id` int(11) NOT NULL COMMENT '店铺商品分类id',
  `goods_id` int(11) NOT NULL COMMENT '商品id'
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品店铺分类存储表';

CREATE TABLE `#__store_extend` (
  `store_id` mediumint(8) unsigned NOT NULL COMMENT '店铺ID',
  `express` text COMMENT '快递公司ID的组合',
  PRIMARY KEY  (`store_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺信息扩展表';
...
CREATE TABLE `#__store_goods_class` (
  ...
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺商品分类表';
...
CREATE TABLE `#__store_grade` (
  ...
  PRIMARY KEY (`sg_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺等级表';
...
CREATE TABLE `#__store_gradelog` (
  ...
  PRIMARY KEY  (`gl_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺升级申请记录表';
...
CREATE TABLE `#__store_navigation` (
  ...
  PRIMARY KEY (`sn_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='卖家店铺导航信息表';
...
CREATE TABLE `#__store_partner` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='卖家店铺合作伙伴表';
...
CREATE TABLE `#__store_watermark` (
  ...
  `store_id` int(11) default NULL COMMENT '店铺id',
  PRIMARY KEY  (`wm_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='店铺水印图片表';

CREATE TABLE `#__transport` (
  `id` mediumint(8) unsigned NOT NULL auto_increment COMMENT '运费模板ID',
  `title` varchar(120) default NULL COMMENT '运费模板名称',
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='运费模板';
...
CREATE TABLE `#__transport_extend` (
  ...
  `transport_title` varchar(120) default NULL COMMENT '运费模板',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='运费模板扩展表';
...
CREATE TABLE `#__type` (
	...
	`type_sort` tinyint(1) unsigned NOT NULL COMMENT '排序',
	 PRIMARY KEY  (`type_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品类型表';

CREATE TABLE `#__type_brand` (
	`type_id` int(10) unsigned NOT NULL COMMENT '类型id',
	`brand_id` int(10) unsigned NOT NULL COMMENT '品牌id'
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品类型与品牌对应表';

CREATE TABLE `#__type_spec` (
	`type_id` int(10) unsigned NOT NULL COMMENT '类型id',
	`sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='商品类型与规格对应表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='上传文件表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='代金券表';
...
CREATE TABLE `#__voucher_apply` (
  ...
  PRIMARY KEY  (`apply_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='代金券套餐申请表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='代金券面额表';
...
CREATE TABLE `#__voucher_quota` (
  ...
  PRIMARY KEY  (`quota_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='代金券套餐表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='代金券模版表';
...
CREATE TABLE `#__web` (
  ...
  PRIMARY KEY  (`web_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='页面模块表';
...
CREATE TABLE `#__web_code` (
  ...
  PRIMARY KEY  (`code_id`),
  KEY `web_id` (`web_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='模块内容表';
...
CREATE TABLE `#__ztc_glodlog` (
  ...
  PRIMARY KEY  (`glog_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='直通车金币日志表';
...
CREATE TABLE `#__ztc_goods` (
  ...
  PRIMARY KEY  (`ztc_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='直通车申请表';
...
INSERT INTO `#__seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES (1, '{sitename} - Powered by ShopNC', 'ShopNC,PHP商城系统,ShopNC商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', 'ShopNC专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index');
...
INSERT INTO `#__article` (`article_id`, `ac_id`, `article_url`, `article_show`, `article_sort`, `article_title`, `article_content`, `article_time`) VALUES(35, 1, 'http://www.shopnc.net/', 1, 255, '2.3版火爆销售中', '2.3版火爆销售中<br />', 1351302887);
...
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (2, '男女服饰', 'clothing_item', '这里面的商品将在首页的男女服饰区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (3, '鞋包配饰', 'ornament_item', '这里面的商品将在首页的鞋包配饰区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (4, '美容美妆', 'cosmetic_item', '这里面的商品将在首页的美容美妆区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (5, '运动户外', 'sports_item', '这里面的商品将在首页的运动户外区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (6, '数码家电', 'electron_item', '这里面的商品将在首页的数码家电区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (7, '家居家装', 'furniture_item', '这里面的商品将在首页的家居家装区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (8, '食品保健', 'food_item', '这里面的商品将在首页的食品保健区域显示', NULL);
INSERT INTO `#__recommend` (`recommend_id`, `recommend_name`, `recommend_code`, `recommend_desc`, `recommend_config`) VALUES (9, '母婴用品', 'gravida_item', '这里面的商品将在首页的母婴用品区域显示', NULL);

INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(1, '男女服装', 1, '服装', 0, 0, 1, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(2, '鞋包配饰', 0, '', 0, 0, 2, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(3, '美容美妆', 0, '', 0, 0, 3, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(4, '数码家电', 0, '', 0, 0, 5, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(5, '家居家装', 0, '', 0, 0, 6, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(6, '食品保健', 0, '', 0, 0, 7, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(7, '母婴用品', 0, '', 0, 0, 8, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(8, '运动户外', 0, '', 0, 0, 4, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(9, '文化娱乐', 0, '', 0, 0, 9, 1, 0);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(10, '话费网游', 0, '', 0, 0, 10, 1, 0);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(11, '票务旅游', 0, '', 0, 0, 11, 1, 0);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(12, '女装', 1, '服装', 0, 1, 255, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(13, '男装', 1, '服装', 0, 1, 255, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(14, '内衣/睡衣', 1, '服装', 0, 1, 255, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(15, '羽绒服', 1, '服装', 0, 13, 255, 1, 1);
INSERT INTO `#__goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `store_id`, `gc_parent_id`, `gc_sort`, `gc_show`, `gc_index_show`) VALUES(16, '棉衣', 1, '服装', 0, 12, 255, 1, 1);
...
INSERT INTO `#__store_grade` (`sg_id`, `sg_name`, `sg_goods_limit`, `sg_space_limit`, `sg_template_number`, `sg_template`, `sg_price`, `sg_confirm`, `sg_description`, `sg_function`, `sg_sort`) VALUES(1, '系统默认', 100, 100, 6, 'default|style1|style2|style3|style4|style5', '100元/年', 0, '用户选择“默认等级”，可以立即开通。', '', 0);
INSERT INTO `#__store_grade` (`sg_id`, `sg_name`, `sg_goods_limit`, `sg_space_limit`, `sg_template_number`, `sg_template`, `sg_price`, `sg_confirm`, `sg_description`, `sg_function`, `sg_sort`) VALUES(2, '白金店铺', 200, 100, 6, 'default|style1|style2|style3|style4|style5', '200元/年', 1, '享受更多特权', 'editor_multimedia', 2);
