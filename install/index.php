...
<li>本协议是您与网城创想公司之间关于您安装使用网城创想公司提供的ShopNC商城系统及服务的法律协议，若您需将ShopNC商城系统或服务用于商业用途，必须另行获得网城创想的授权许可，您在获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</li>
</ol>
<p></p>
<h3>II. 协议规定的约束和限制</h3>
<ol>
...
<p>一旦您开始安ShopNC商城系统，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权利的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
<p></p>
<p align=right>天津市网城创想科技有限责任公司（2012年10月27日）</p>
</div>',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成：</p>
		...
		<p class=\'nes\'>3.如果安装了演示数据，<font color=\'FF0000\'>测试账号和密码都为shopnc</font></p>',
...
?>
			<div class="footer"><p>Powered by <a href="http://www.shopnc.net" target="_blank">ShopNC </a>© v2.3 2007-2013 <a href="http://www.shopnc.net" target="_blank">网城创想</a> Inc.</p>
