  ...
  <div class="nc-home-pattern style-<?php echo $output['style_name'];?>">
    <div class="rightbar">
      ...
      <ol class="saletop-list">
        ...
        <li class="top">
          <dl>
            <dt class="goods-name"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods'); ?>" target="_blank" title="<?php echo $val['goods_name'];?>">
            	<?php echo $val['goods_name'];?></a></dt>
            <dd class="nokey"><?php echo $i;?></dd>
            <dd class="goods-pic"><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods'); ?>" target="_blank" title="<?php echo $val['goods_name'];?>"><span class="thumb size60"><i></i>
        ...
        <li class="normal"><i><?php echo $i;?></i>
        	<a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$val['goods_id'],'id'=>$val['store_id']), 'goods'); ?>" target="_blank" title="<?php echo $val['goods_name'];?>"><?php echo $val['goods_name'];?></a></li>
										        	<?php } ?>
							        <?php } ?>
              		<?php } ?>
      </ol>
    ...
    <div class="middle">
      ...
      <div class="tabs-panel <?php echo $key==1 ? '':'tabs-hide';?>">
        ...
        <?php foreach($val['goods_list'] as $k => $v){ ?>
          <li>
            <dl>
              <dt class="goods-name"><a target="_blank" href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id'],'id'=>$v['store_id']),'goods'); ?>" title="<?php echo $v['goods_name']; ?>">
