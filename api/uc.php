...
define('SHOPNC_ROOT', substr(dirname(__FILE__), 0, -3));
...
class uc_note {
	...
	function updatecredit($get, $post) {
		...
		require_once SHOPNC_ROOT.'./uc_client/data/cache/creditsettings.php';
	...
	function updatecreditsettings($get, $post) {
		...
		$cachefile = SHOPNC_ROOT.'./uc_client/data/cache/creditsettings.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
